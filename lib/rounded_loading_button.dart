...
class RoundedLoadingButtonState extends State<RoundedLoadingButton> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    var _check = Container(
      ...
      child: _bounceAnimation.value > 20 ? Icon(Icons.check, color: Colors.white,) : null
    );
    ...
    var _cross = Container(
      ...
      width: _bounceAnimation.value,
      height: _bounceAnimation.value,
      child: _bounceAnimation.value > 20 ? Icon(Icons.close, color: Colors.white,) : null
    );
  ...
  void initState() {
    ...
    _bounceAnimation = Tween<double>(begin: 0, end: widget.height).animate(new CurvedAnimation(parent: _checkButtonControler, curve: Curves.elasticOut));
    _bounceAnimation.addListener(() {
      setState(() {});
    });

    _squeezeAnimation = Tween<double>(begin: 300, end: widget.height).animate(new CurvedAnimation(parent: _buttonController, curve: Curves.easeInOutCirc));
